...
import (
	...
	httpapi "github.com/holisticode/swarm/api/http"
	"github.com/holisticode/swarm/bzzeth"
	...
	pssmessage "github.com/holisticode/swarm/pss/message"
	"github.com/holisticode/swarm/pushsync"
...
func NewSwarm(config *api.Config, mockStore *mock.NodeStore) (self *Swarm, err error) {
	...
	if isLegacy {
		return nil, errors.New("Legacy database format detected! Please read the migration announcement at: https://github.com/holisticode/swarm/blob/master/docs/Migration-v0.3-to-v0.4.md")
	}
